...
export const heroSteps = [
  ...
  },
  {
    index: "02",
    title: "多路召回人选",
    text: "已有候选人、人才版图、公开与学术来源一起找，不押注单一平台。",
    icon: "search",
  },
  {
    index: "03",
...
export const mechanismStages = [
  ...
  },
  {
    ...
    label: "多路召回",
    title: "所有能找到人的地方，一起跑",
    text: "先查已有候选人和人才版图，再扩到公开网络、论文、专利、开源项目与配套寻访工具回传的结果。渠道覆盖和缺口都看得见。",
    proof: "6 类渠道 · 并行寻访",
    facts: [
      "已有候选人",
      "目标公司与团队",
...
export const scenarios = [
  ...
  },
  {
    id: "platform",
    title: "认证人才平台",
    trigger: "需要登录的平台，由配套寻访工具执行",
    description:
      "云端不会替你自动操作已登录的人才平台。配套寻访工具执行任务，用户确认的结果回到 Hunter，再与其他渠道统一身份、查重和匹配。",
    output: "一批经你确认、可进入统一候选池的结果",
  },
];
